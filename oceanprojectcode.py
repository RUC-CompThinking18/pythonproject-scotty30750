...
Question_1 =Question("Is plastic the most common element in the ocean?", "T", "Plastic is the most common element that is found in the ocean. It is harmful for the environment as it does not get break down easily and is often considered as food by marine animals. -true")
...
Question_3 =("Over a million birds are killed from pollution each year.", "T", "Over one million seabirds are killed by ocean pollution each year. Three hundred thousand dolphins and porpoises die each year as a result of becoming entangled in discarded fishing nets, among other items. One hundred thousand sea mammals are killed in the ocean by pollution each year. -true")
...
Question_7 =("Toxic metals can destroy marine life.", "T", "Toxic metals can destroy the biochemistry, behavior, reproduction, and growth in marine life. -true")
...
Question_10 =("Sewage doesn't lead to the decomposition of organic matter.", "F", "Sewage leads to the decomposition of organic matter that in turn leads to a change in biodiversity. Even if the ocean’s ecosystem isn’t destroyed entirely, it is still changed drastically, and usually not for the better. -false")

Question_11 =("Industrial run off can't affect ocean well being.", "F", "Fertilizer runoff creates eutrophication that flourishes algal bloom (rapid increase or accumulation in the population of algae in aquatic systems) which depletes the oxygen content in the water that affects marine life. -false")
...
Question_13 =("People can't be affected by bad seafood.", "F", "People get contaminated easily by eating contaminated seafood that can cause serious health problems, from cancer to damage to immune system. -false")
...
Question_15 =("Salt water from the oceans can push pollutants into freshwater areas.", "T", "Salty water of ocean has the capability to move pollutants from the ocean into coastal freshwater making wells and groundwater contaminated. -true")
...
Question_17 =("Pollutants can disappear in the ocean.", "F", "As 70% of the earth is covered with water, people actually assumed that all pollutants would be diluted and get disappeared. But in reality, they have not disappeared and their effects can be easily seen as they have entered the food chain. -false")
...
Question_19 =("Eutrophication cannot create dead zones.", "F", "In several parts of the world including Gulf of Mexico and the Baltic Sea, Eutrophication has created enormous dead zones. -false")

Question_20 =("Dumping sewage into the ocean isn't a big deal.", "F", "Till today, in many parts of the world, sewage water is discharged in the ocean – untreated or under-treated. This can cause serious effect on marine and human life and can also lead to eutrophication.-false")
